		...
		<main class="flex-shrink-0">
			<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
								...
								<form:form method="post" modelAttribute="update_film_attr" action="${pageContext.request.contextPath}/film/update" novalidate="novalidate" class="row g-3">
			...
			<!-- 						</div> -->
									<div class="col-12">	
										...
										<input type="hidden" id="id" name="id" value="${update_film_attr.id}">
